...
export interface MeetingDocument<IsCancelled extends boolean>
  extends MeetingDocumentMetadata<IsCancelled> {
...
function isMeetingDocument(json: any): json is MeetingDocument<boolean> {
  ...
  if (json.latestMinutes === null && json.latestMinutesLink != null)
    return false;
